    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" class="repeater" action="{{ route('application.store')}}">
                        @csrf
                        <h5>Basic Details:</h5>
                        <div class="row">
                            <div class="col-4">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control"  name="address" id="" cols="0" rows="3"></textarea>
                                </div>    
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="">Contact <span style="color: red;">*</span></label>
                                    <input type="number" name="contact" class="form-control" id="" placeholder="">
                                </div>     
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="university" class="form-control" id="" aria-describedby="emailHelp" placeholder="Board/University">
                                </div>    
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="percentage"  class="form-control" step=".01" id="" placeholder="">
                                </div>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="designation" class="form-control" id="" placeholder="">
                                </div>
                            </div>`
                        </div>
                        <div class="row">
                                    ...
                                    <div class="form-group">    
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="hindiCheck" name="hindiCheck" value="hindiCheck" class="custom-control-input">
                                                <label class="custom-control-label" for="hindiCheck">Hindi</label>
                                            </div>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="hinreadCheck" name="hinreadCheck" value="hinreadCheck" class="custom-control-input" disabled>
                                                <label class="custom-control-label" for="hinreadCheck">Read</label>
                                            </div>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="hinwriteCheck" name="hinwriteCheck" value="hinwriteCheck" class="custom-control-input" disabled>
                                                <label class="custom-control-label" for="hinwriteCheck">Write</label>
                                            </div>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="hinspeakCheck"  name="hinspeakCheck" value="hinspeakCheck" class="custom-control-input" disabled>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">        
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="engCheck" name="engCheck"  value="engCheck" class="custom-control-input">
                                                <label class="custom-control-label" for="engCheck">English</label>
                                            </div>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="engreadCheck" name="engreadCheck"  value="engreadCheck" class="custom-control-input" disabled>
                                                <label class="custom-control-label" for="engreadCheck">Read</label>
                                            </div>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="engwriteCheck"  name="engwriteCheck"  value="engwriteCheck" class="custom-control-input indeterminate-checkbox" disabled>
                                                <label class="custom-control-label" for="engwriteCheck">Write</label>
                                            </div>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="engspeakCheck"  name="engspeakCheck"  value="engspeakCheck" class="custom-control-input" disabled>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">        
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="gujaratiCheck" name="gujaratiCheck"  value="gujaratiCheck" class="custom-control-input">
                                                <label class="custom-control-label" for="gujaratiCheck">Gujarati</label>
                                            </div>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="gujreadCheck" name="gujreadCheck"  value="gujreadCheck"  class="custom-control-input" disabled>
                                                <label class="custom-control-label" for="gujreadCheck">Read</label>
                                            </div>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="gujwriteCheck" name="gujwriteCheck"  value="gujwriteCheck"  class="custom-control-input" disabled>
                                                <label class="custom-control-label" for="gujwriteCheck">Write</label>
                                            </div>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="gujspeakCheck" name="gujspeakCheck"  value="gujspeakCheck"  class="custom-control-input" disabled>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">    
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="php" name="php" value="php" class="custom-control-input">
                                                <label class="custom-control-label" for="php">PHP</label>
                                            </div>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="phpbeginner" name="phpbeginner" value="phpbeginner"  class="custom-control-input" disabled>
                                                <label class="custom-control-label" for="phpbeginner">Beginner</label>
                                            </div>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="phpmediator" name="phpmediator" value="phpmediator" class="custom-control-input" disabled>
                                                <label class="custom-control-label" for="phpmediator">Mediator</label>
                                            </div>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="phpexpert" name="phpexpert" value="phpexpert" class="custom-control-input" disabled>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">        
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="mysql" name="mysql"  value="mysql" class="custom-control-input">
                                                <label class="custom-control-label" for="mysql">MYSQL</label>
                                            </div>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="mysqlbeginner" name="mysqlbeginner" value="mysqlbeginner" class="custom-control-input" disabled>
                                                <label class="custom-control-label" for="mysqlbeginner">Beginner</label>
                                            </div>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="mysqlmediator" name="mysqlmediator" value="mysqlmediator" class="custom-control-input" disabled>
                                                <label class="custom-control-label" for="mysqlmediator">Mediator</label>
                                            </div>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="mysqlexpert" name="mysqlexpert" value="mysqlexpert" class="custom-control-input" disabled>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">        
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="laravel" name="laravel"  value="laravel" c class="custom-control-input">
                                                <label class="custom-control-label" for="laravel">Laravel</label>
                                            </div>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="laravelbeginner"  name="laravelbeginner" value="laravelbeginner"  class="custom-control-input" disabled>
                                                <label class="custom-control-label" for="laravelbeginner">Beginner</label>
                                            </div>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="laravelmediator"  name="laravelmediator" value="laravelmediator" class="custom-control-input indeterminate-checkbox" disabled>
                                                <label class="custom-control-label" for="laravelmediator">Mediator</label>
                                            </div>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" id="laravelexpert" name="laravelexpert" value="laravelexpert" class="custom-control-input" disabled>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="ectc" class="form-control" id="" placeholder="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="cctc" class="form-control" id="" placeholder="">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="">Notice Period(In month) <span style="color: red;">*</span></label>
                                        <input type="number" name="notice_period" class="form-control" id="" placeholder="Notice Period In Month"><span></span>
                                    </div>
                                </div>
                            </div>
                        </div>
